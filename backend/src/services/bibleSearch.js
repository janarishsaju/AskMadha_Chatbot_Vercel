...
const BOOK_ABBREVIATIONS = {
  'தொநூ': 'தொடக்க நூல்', 'தொடக்கநூல்': 'தொடக்க நூல்', 'விப': 'விடுதலைப் பயணம்', 'விடுதலைப்பயணம்': 'விடுதலைப் பயணம்', 'லேவி': 'லேவியர்',
  'எண்': 'எண்ணிக்கை', 'இச': 'இணைச் சட்டம்', 'இணைச்சட்டம்': 'இணைச் சட்டம்', 'யோசு': 'யோசுவா',
  'நீத': 'நீதித் தலைவர்கள்', 'நீதித்': 'நீதித் தலைவர்கள்', 'நீதித்தலைவர்கள்': 'நீதித் தலைவர்கள்', 'ரூத்': 'ரூத்து',
  ...
  'நீமொ': 'நீதிமொழிகள்', 'சஉ': 'சபை உரையாளர்', 'சபையுரையாளர்': 'சபை உரையாளர்', 'இபா': 'இனிமைமிகு பாடல்',
  'சாஞா': 'சாலமோனின் ஞானம்', 'சாலமோனின்ஞானம்': 'சாலமோனின் ஞானம்', 'சீஞா': 'சீராக்',
  ...
  'திப': 'திருத்தூதர் பணிகள்', 'திருத்தூதர்பணிகள்': 'திருத்தூதர் பணிகள்', 'உரோ': 'உரோமையர்',
  ...
  for (const curated of CURATED_TOPICS) {
    ...
    if (groupsMatched === curated.keywordGroups.length) {
      for (const r of curated.refs) {
        // Split at the last space to separate book name from chapter:verse
        const lastSpaceIdx = r.lastIndexOf(' ');
        if (lastSpaceIdx === -1) continue;
        const book = r.substring(0, lastSpaceIdx);
        const cv = r.substring(lastSpaceIdx + 1);
        const [c, v] = cv.split(':');
