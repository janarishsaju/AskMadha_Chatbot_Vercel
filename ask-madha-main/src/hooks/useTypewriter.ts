 ...
 *
 * @param fullText  The complete text received so far (grows as tokens arrive).
 * @param done      When true, speeds up to flush remaining characters quickly.
 * @param speed     Milliseconds between ticks (default 15ms).
 * @returns         The portion of text revealed so far.
 */
export function useTypewriter(fullText: string, done: boolean, speed: number = 15): string {
